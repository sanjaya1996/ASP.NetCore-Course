...
namespace CRUDTests
{
    public class CountriesServiceTest
    {
        ...
        // When the proper CountryName is supplied, it should insert (add) the country to the existing list of countries
        [Fact]
        ...
        public void GetAllCountries_EmtpyList()
        {
            // Act
        ...
        public void GetAllCountries_AddFewCountries()
        {
            ...
            // read each element from countries_list_from_country
        ...
        public void GetCountryByCountryID_ValidCountryID()
        {
            ...
            // Assert
            Assert.Equal(country_response_from_get_method, country_response_from_add_request);
        }
        #endregion
    }
}
